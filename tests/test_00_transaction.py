...
class TestTransaction(TestCase):
    ...
    def test_charge_and_verify(self):
        ...
        """
        transaction_details = {"amount": 1000 * 100, "email": "test_customer@mail.com"}
        ...
        def initialize_transaction():
            (
                ...
                status,
                response_msg,
                initialized_transaction_data,
            ) = self.transaction.initialize(**transaction_details)
        ...
        def verify_transaction():
            ...
            self.assertEqual(
                response_data.get("customer")["email"], transaction_details["email"]
            )
